...
const TOUR_STEPS = [
    ...
    },
    {
        viewId: 'ai-studio',
        title: 'AI Studio',
        description: 'Supercharge your workflow. Generate SEO-friendly titles, descriptions, and tags instantly. Lock in your preferred style templates to ensure brand consistency across all your content.',
        icon: (
